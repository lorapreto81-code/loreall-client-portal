          ...
          {matches.length > 1 ? (
            ...
            <>
              ...
              <a
                ...
                className="mt-4 w-full py-2 md:py-3 flex items-center justify-center gap-2 rounded-lg border border-input bg-background text-xs md:text-sm font-medium text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors"
              >
                <MessageCircle className="h-4 w-4" />
                <span className="md:hidden">Criar minha conta</span>
                <span className="hidden md:inline">Não tenho acesso — quero criar minha conta</span>
              </a>
            </>
          )}
        </div>
